//CONSULTO INFO
const GET_CONSULTO_MODULOS = "http://192.168.1.5/inverna/php2/consulto-modulos-activos.php";
const CONSULTO_MODULO = "php2/consulto-modulo.php";
...
const AGREGO_INVERNADEROS = "php/agrego-invernaderos.php";